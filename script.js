/**
 * AXIS COMMUNITY - ОПТИМИЗИРОВАННЫЙ JAVASCRIPT
 * Модули: Canvas частицы, Мобильное меню, Reveal анимации, Слайдер правил
 */

'use strict';

document.addEventListener('DOMContentLoaded', () => {
    // Сброс скролла при перезагрузке (F5 / Ctrl+R)
    ...
    /* ============================================
       CANVAS: АНИМАЦИЯ ЧАСТИЦ (Particle Network)
       ============================================ */
    const initCanvas = () => {
        ...
        // Анимационный цикл (30fps для производительности)
        const animate = (time) => {
